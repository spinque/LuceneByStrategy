...
public class CodeViewWidget extends Composite {

	interface MyUiBinder extends UiBinder<Widget, CodeViewWidget> {}
	...
	public CodeViewWidget(BuildingBlockOverlay bb) {
		initWidget(uiBinder.createAndBindUi(this));
		descriptionDiv.setInnerText(bb.getDescription());
		prepareCode(bb.getCode("xml"), codeDiv);
	}
